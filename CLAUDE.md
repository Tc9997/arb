...
**YOU ARE IN: `arb/polecats/guzzle/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/arb/` (rig root) or other directories
...
**Your mail address:** `arb/polecats/guzzle`
**Your rig:** arb
**Your Witness:** `arb/witness`
...
| Ask Witness for help | `gt mail send arb/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`arb/witness`) when:
...
```bash
gt mail send arb/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
